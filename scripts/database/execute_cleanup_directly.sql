-- =========================================================================
-- EXECUTE CLEANUP DIRECTLY VIA CLI
-- =========================================================================
-- This will complete the table descriptions and cleanup that the migration didn't finish

-- First, add table descriptions
...
-- Now remove the empty partition tables
...
SELECT 'Cleanup Complete' as status, 
       COUNT(*) as remaining_news_tables
FROM information_schema.tables 
WHERE table_schema = 'public' 
AND table_name LIKE 'news%';

SELECT 'Table Descriptions Added' as status,
       COUNT(*) as tables_with_descriptions
FROM pg_class c
