...
('news-intelligence-001', 'News Intelligence Agent', 'analyzer', 'Processes financial news and extracts insights', 
 ARRAY['news_ingestion', 'sentiment_analysis', 'entity_extraction', 'market_impact_assessment'], 'active')
...
AND table_name IN (
    'a2a_agents', 'a2a_messages', 'agent_activity', 
    'agent_blockchain_activities', 'breaking_news_alerts', 
    'news_sentiment_analysis', 'news_market_impact', 
