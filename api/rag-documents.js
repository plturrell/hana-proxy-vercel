/**
 * RAG Documents API Endpoint (Alternative location)
...
export default async function handler(req, res) {
  // Initialize Supabase client inside handler to avoid module-level issues
  ...
  try {
    switch (method) {
      case 'GET':
        return await getDocuments(req, res, supabase);
      default:
...
async function getDocuments(req, res, supabase) {
  try {
